...
| F4      | P1       | CI             | `npm run lint` is a no-op                                                     | ~~M5~~ **resolved (2026-07-10) — real per-package lint scripts landed in M4; M5 re-verified and closed the CI-wiring half**                                                                                                                        |
| F5      | P1       | CI             | Coverage never generated; codecov upload dead                                 | ~~M5~~ **resolved (2026-07-10) — both packages' `test` scripts now always run with `--coverage`; codecov upload wired for core+extension lcov; thresholds derived from measured coverage, not guessed**                                            |
